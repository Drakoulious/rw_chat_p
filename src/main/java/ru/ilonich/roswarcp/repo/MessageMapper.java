...
public interface MessageMapper {
    ...
    @Results({
            ...
            @Result(property = "flags", column = "flags", javaType = Integer.class, jdbcType = JdbcType.INTEGER),
            ...
            @Result(property = "clanStatus", column = "clan_status", javaType = String.class, jdbcType = JdbcType.VARCHAR)
    })
